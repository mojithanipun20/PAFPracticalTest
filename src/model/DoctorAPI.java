...
public class DoctorAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = doctorobj.insertdoctor(request.getParameter("doc_ID"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = doctorobj.updatedoctor(paras.get("hiddoc_numSave").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = doctorobj.deletedoctor(paras.get("doc_num").toString());
		response.getWriter().write(output); 
		// TODO Auto-generated method stub
